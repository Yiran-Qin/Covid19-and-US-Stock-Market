...
cfm_cities <- read_csv("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_US.csv")
dth_cities <-  read_csv("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_US.csv")
mydata <- read_csv("https://raw.githubusercontent.com/jerrygrm/final-project-covid-stock/master/daily.csv")
...
ui <- dashboardPage( 
    dashboardHeader(title="U.S. Covid19 vs Stock"), 
    dashboardSidebar(
        sidebarMenu(
        ...
        tabItems(
            ...
            tabItem(tabName = "PlotA",
                    fluidRow(
                        ...
                        box(width = 6,
                            h4("Correlation between Stocks and Death Cases in US"),
